const Footer = () => {
    const siteName = 'Next.js + Drupal';
    return (
        <footer className='pt-5 pb-5 text-center'>
            <div className="container">
                <div className="ib mt-3 mb-6 ">
                    <svg className='mx-auto' viewBox="0 0 172 16" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <p>&copy; Copyright {new Date().getFullYear()}, All Rights Reserved by {siteName}</p>
            </div>
        </footer>
    )
}
